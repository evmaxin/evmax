...
class BecomeASeller extends CI_Controller {
    ...
    public function index() {
        ...
        $template['title'] = "Become a Seller";
        ...
        $template['content'] = $this->load->view('frontpages/becomeaseller/enquiry', $contents, TRUE);
        $this->load->view('frontpages/template_becomeaseller', $template);
         */
    }
