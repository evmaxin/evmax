	...
	$template['content'] = $this->load->view('frontpages/merchant_reg/index', $contents, TRUE);
     ...
     public function verifyOTP() {
      ...
      $otp_condition = array(
        ...
        $contents['otp_details'] = $this->common->getTableData($tablename = "m_registration", $cols = "otp,person_email",$otp_condition);
        ...
        $this->common->update($table='m_enquiry', $enq_parameters, $enq_condition);//to hide enq values
       // echo $this->db->last_query(); 
        //var_dump($contents['otp_details']);
        // echo count($contents['otp_details']); exit;
