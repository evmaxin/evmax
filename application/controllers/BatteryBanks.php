...
class BatteryBanks extends CI_Controller {
	...
	public function index()
        {
             $data['title'] = "Battery Banks";
            $this->load->library('leaflet');
             $this->load->model(array('Common_model' => 'common'));
    $getMarkers = $this->common->getTableData($tablename = "batterybanks", $cols = "lat,lng,name,address");
      $config = array(
...
//$this->leaflet->add_marker($marker1);
 ...
 $this->load->view('frontpages/batterybanks/index',$data);
