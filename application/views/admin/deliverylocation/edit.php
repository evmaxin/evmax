                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="portlet">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-shopping-cart"></i><?php echo ($products[0]->company_name)?$products[0]->company_name:'';?> </div>
                                        ...
                                        <div class="portlet-body">
                                            <div class="">
                                                        ...
                                                        <div class="form-body">
                                                            <form action="<?php echo base_url();?>admin/DeliveryLocation/update/<?php echo ($products[0]->id)?$products[0]->id:0;?>" method="post" enctype="multipart/form-data" id="addproduct">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input class="form-control" type="text" name="company_name" id="company_name" value="<?php echo ($products[0]->company_name)?$products[0]->company_name:'';?>" required /> </div>
                                                            </div>
                                                                   <div class="form-group padding-bottom-40">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input class="form-control" type="text" name="lang" id="lang" value="<?php echo ($products[0]->lang)?$products[0]->lang:'';?>" required  /> </div>
                                                            </div>
                                                                ...
                                                                <label class="col-md-2 control-label">Plot or Flat:
                                                                     <span class="required"> * </span>
                                                                </label>
                                                                <div class="col-md-10 mb30">
                                                                    <input type="text" class="form-control" name="plot_flat" id="plot_flat" value="<?php echo ($products[0]->plot_flat)?$products[0]->plot_flat:'';?>" required/>
                                                                    </div>
                                                            </div>
                                                                   <div class="form-group mb30">
