<div class="page-content">
    ...
    <div class="row">
		...
		<?php   //print_r($attributes); ?>
            <form action="<?php echo base_url(); ?>admin/dataMgnt/AddVarient/update/<?php echo $this->uri->segment(5)?$this->uri->segment(5):$attributes[0]->model_id ?>" method="post">
                    ...
                    <div class="col-md-10">
                        <select name="attribute_type" id="attribute_type" class="form-control" required>
                            ...
                            <?php if(isset($attributetype)) { foreach ($attributetype as $type): ?>
                                <option value="<?php echo $type->model_id; ?>" <?php if ($attributes[0]->model_id == $type->model_id) {
                                echo "selected";
                            } ?> ><?php echo $type->model_name; ?></option>
                            <?php endforeach; } ?>
                        </select>
                    </div>
                </div>
