      ...
      <div class="row">
        <div class="col-md-12">
          <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption"> <i class="icon-user-follow"></i>Add Sub Category</div>
        ...
        <table id="table" class="table table-striped table-hover table-bordered display" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <form action="<?php echo base_url(); ?>admin/dataMgnt/AddSubCategory/add" method="post">
...
if (answer)
{
      $.ajax({
      type: "POST",
      url: "<?=base_url();?>admin/dataMgnt/AddSubCategory/destroy/"+id+"",   
      data: {'id':id},
