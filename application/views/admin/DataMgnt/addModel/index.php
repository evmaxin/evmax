      ...
      <div class="row">
        <div class="col-md-12">
          <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption"> <i class="icon-user-follow"></i>Model</div>
        ...
        <table id="table" class="table table-striped table-hover table-bordered display" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <form action="<?php echo base_url(); ?>admin/dataMgnt/AddModel/add" method="post">
                                      ...
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div class="form-group">
                                                  ...
                                                  <select name="m_registration_id" id="attribute_type"  class="form-control" required>
                                                      <option value="">Select</option>
                                                      <?php foreach ($attributetype as $type): ?>
                                                          <option value="<?php echo $type->m_registration_id; ?>"><?php echo $type->company_name; ?></option>
                                                      <?php endforeach; ?>
                                                  </select>
                                              ...
                                              <div class="form-group">
                                                  <label class="control-label">Model Name <span class="required">*</span></label>
                                                  <input type="text" name="Model_Name" id="attribute_name" class="form-control" required /> <br>
...
if (answer)
{
      $.ajax({
      type: "POST",
      url: "<?=base_url();?>admin/dataMgnt/AddModel/destroy/"+id+"",   
      data: {'id':id},
