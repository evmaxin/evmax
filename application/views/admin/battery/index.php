        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-list"></i>Battery</div>
                ...
                <form action="<?php echo base_url(); ?>admin/Battery/add" method="post" enctype="multipart/form-data" id="addproduct">
                        ...
                        <div class="modal-dialog modal-dialog-confirm">
                            <div class="modal-content " style="height: 800px;overflow: scroll;">
                                <div class="modal-header"> <a type="button" class="close" data-dismiss="modal" aria-hidden="true"></a>
                                    <h4 class="modal-title">Add Battery <button class="btn default" data-dismiss="modal" style="float: right;">Close</button></h4> 
                                </div>
 ...
 <div class="form-group">
     ...
     <div class="form-group">
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                    <label class="control-label">Inventory <span class="required"> * </span></label>
    ...
    <div class="form-group col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                                    <label class="control-label">Suitable Vehicles</label>
                                                    <input type="text" name="suitablevehicles" id="suitablevehicles" class="form-control" />
...
<div class="form-group">
                                                  ...
                                                  <small class="required">Minimum width and Height are 400x500 and 700x700 are recommended </small>
                                              </div>
...
<script>
    $('body').on('click', '.product_id', function () {
        ...
        if (answer)
        {
            $.ajax({
                type: "POST",
                url: "<?= base_url(); ?>admin/Ajax/eventOnBattery",
