        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-list"></i>Menu</div>
                ...
                <form action="<?php echo base_url(); ?>admin/Menu/add" method="post" enctype="multipart/form-data" id="addproduct">
...
<script>
        ...
        if (answer)
        {
            $.ajax({
                type: "POST",
                url: "<?= base_url(); ?>admin/Menu/eventOnContlr",
