                    ...
                    <tr>
                        <td align="left" style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 10px;">
                            <p style="font-size: 16px; font-weight: 400; line-height: 24px; color: #777777;">
                                Dear <?php echo $this->session->userdata('enquiry_name')?$this->session->userdata('enquiry_name'):''; ?>, below is the registration links
                            </p>
                            <p style="font-size: 18px; font-weight: 400; margin: 0; color: green;"><a href="<?php echo base_url()?>Registration/index?name=<?php echo $this->session->userdata('enquiry_name')?>&email=<?php echo $this->session->userdata('enquiry_email')?>" target="_blank" style="color: #57b952; text-decoration: none;">Click to Register &nbsp;</a></p>
                        </td>
                    </tr>
