     ...
     <div class="form-group">
       ...
       <div class="form-group">
                 ...
                 <option value="<?php //echo $type->category_type_id;  ?>"><?php // echo $type->category_type; ?></option>
                                                ...
                                                <div class="form-group" id="hidden_catdiv">
                                                    <b>If Category not Available </b><a target="_blank" href="<?php echo base_url() ?>/admin/Category/index/">Add category from here</a>
                                                </div>
