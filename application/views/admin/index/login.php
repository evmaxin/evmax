        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset mt-login-5-bsfix">
                    <img class="login-logo"  style="max-width: 675px;" src="<?php echo base_url() ?>assets/admin/custom_images/evscooty.png" />
                    <div class="login-bg">
                         </div>
                </div>
          ...
          <?php } ?>
                            <div class="row">
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix form-group" type="text" autocomplete="off" placeholder="Username" name="username" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" minlength="10" maxlength="45" required title="Minimum 10 and max 45 characters allowed"/> </div>
                                <div class="col-xs-6">
