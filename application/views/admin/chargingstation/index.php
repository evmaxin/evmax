...
<div class="page-content">
    <div class="row">
        <div class="col-md-12 padding-bottom-20">
            ...
            <div class="btn-group col-md-4"> <a id="" class="btn green" data-target="#addNew" data-toggle="modal" > Add Charging Station <i class="fa fa-plus"></i> </a> </div>
        ...
        <div class="col-md-12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-list"></i>Charging Station</div>
                ...
                <form action="<?php echo base_url(); ?>admin/ChargingStation/add" method="post" enctype="multipart/form-data" id="addproduct">
                        ...
                        <div class="modal-dialog modal-dialog-confirm">
                            <div class="modal-content " style="height: 800px;overflow: scroll;">
                                <div class="modal-header"> <a type="button" class="close" data-dismiss="modal" aria-hidden="true"></a>
                                    <h4 class="modal-title">Add Charging Station <button class="btn default" data-dismiss="modal" style="float: right;">Close</button></h4> 
                                </div>
