                                            ...
                                            <div class="tabbable-bordered">
                                                ...
                                                <div class="tab-content" style="width: 100%;">
                                                    <div class="tab-pane active" id="tab_1" style="">
                                                        <div class="form-body">
                                                            <form action="<?php echo base_url();?>admin/ChargingStation/update/<?php echo ($products[0]->id)?$products[0]->id:0;?>" method="post" enctype="multipart/form-data" id="addproduct">
