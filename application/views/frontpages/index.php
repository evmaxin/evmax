  ...
  ?>
    ...
    <div class="col-lg-12 col-md-6 col-sm-12">
               <marquee id='scroll_news'>
                <div onMouseOver="document.getElementById('scroll_news').stop();" onMouseOut="document.getElementById('scroll_news').start();" style="position: relative;top: 4px;padding: 2px 0px;"><a href="<?php echo base_url() ?>BecomeASeller" style="color: #3051a0;font-size: 18px;    font-weight: 800;">"Become A Seller Today”</a></div></marquee>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 max1">
              <div class="shop-product" style="border-radius: 98%;"> 
                <div class="product-box" style="border-radius: 98%;">
                  <a target="<?php echo $img->link_url?'_blank':'';?>" href="<?php echo $img->link_url?$img->link_url:'#';?>"><img src="<?php echo base_url() ?>public/uploads/admin/sliders/<?php echo $img->name;?>"  alt=""></a>
                </div>
              </div>   
...
if(isset($sliderImages)) { 
     ...
     foreach ($sliderImages as $img) {
         if($img->slider_category_id==5){ ?>
                <a target="<?php echo $img->link_url?'_blank':'';?>" href="<?php echo $img->link_url?$img->link_url:'#';?>"><img src="<?php echo base_url() ?>public/uploads/admin/sliders/<?php echo $img->name;?>" class="max4"></a>
                <?php } } }?>
                <!--<span class="maxtst maxtst11"><a href="<?php echo base_url() ?>Mechanics" class="btn btn-common btna">Apply</a></span>-->
            </div>
          </div>
        </div>
...
if(isset($sliderImages)) { 
  ...
  foreach ($sliderImages as $img) {
         if($img->slider_category_id==2){ ?>
            <div class="max3"><a target="<?php echo $img->link_url?'_blank':'';?>" href="<?php echo $img->link_url?$img->link_url:'#';?>"><img src="<?php echo base_url() ?>public/uploads/admin/sliders/<?php echo $img->name;?>" class="max3001"></a></div>
  ...
  foreach ($sliderImages as $img) {
         if($img->slider_category_id==4){ ?>
          ...
          <div class=" col-md-12 col-sm-9 col-xs-12 specialoffr">
            <h1 class="section-title max14 ok">EV MAX Special Offers</h1>
            <hr class="lines">
            <div class="col-md-12">
                    ...
                    <div class="product-info">
                      ...
                      <div class="align-items">
                        ...
                        <div class="pull-right">
                           <span class="price"><del>&#8377;<?php echo $row->actual_price; ?></del></span>
                        </div>
                      </div> 
                    </div>
                  </div>
     ...
     foreach ($sliderImages as $img) {
         if($img->slider_category_id==7){ ?>
                  <div class="client-logo item ">
                    <a target="<?php echo $img->link_url?'_blank':'';?>" href="<?php echo $img->link_url?$img->link_url:'#';?>">
...
if(isset($sliderImages)) { 
     ...
     foreach ($sliderImages as $img) {
         if($img->slider_category_id==5){ ?>
            <a target="<?php echo $img->link_url?'_blank':'';?>" href="<?php echo $img->link_url?$img->link_url:'#';?>"><img src="<?php echo base_url() ?>public/uploads/admin/sliders/<?php echo $img->name;?>" class=""></a>
                <?php } } }?>
            <!--<span class="maxtst maxtst11"><a href="<?php echo base_url() ?>mechanics" class="btn btn-common btna">Apply</a></span>-->
        </div>
...
if(isset($sliderImages)) { 
  ...
  foreach ($sliderImages as $img) {
         if($img->slider_category_id==2){ ?>
              <a target="<?php echo $img->link_url?'_blank':'';?>" href="<?php echo $img->link_url?$img->link_url:'#';?>"><img src="<?php echo base_url() ?>public/uploads/admin/sliders/<?php echo $img->name;?>"></a>
               <?php $i++;} if($i==1) break; } }?>
              </div>
         ...
         if($img->slider_category_id==7){ // clients ?>
                  <div class="col-xs-12 max123 clients-logo  item">
                    <div class="shop-product shop1"> 
                      <div class="product-box">
                        <a target="<?php echo $img->link_url?'_blank':'';?>" href="<?php echo $img->link_url?$img->link_url:'#';?>"><img src="<?php echo base_url() ?>public/uploads/admin/sliders/<?php echo $img->name;?>" alt="<?php echo $img->name;?>" class="logosimg01" /></a>
                      </div>
                    </div>   
                  </div>
