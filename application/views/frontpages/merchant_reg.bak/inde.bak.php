...
provisions of this Agreement.
    ...
    <?php }
                ...
                <div class="row setup-content-2" id="step-4">
                    <div class="col-md-12 reg2 reg22" style="float: none;">
                        <h3 class="font-weight-bold pl-0 my-4  reg3">Validate with OTP</h3>
                        <p style="color:green;" class="success">OTP sent<span id="otp_email"></span> to your email, please enter OTP in below textbox to continue</p>
                        <!--<button id="sendOTP" class="btn btn-mdb-color btn-rounded float-left reg402 reg405" type="button">Send OTP</button>-->
                        ...
                        <button class="btn btn-mdb-color btn-rounded prevBtn-2 float-left reg402" type="button" style="font-size: 12px;" id="previous3">Previous</button>
    ...
    if($('.get_value:checked').length==0){
        ...
        $('.get_value:checked').each(function(){
            $('#'+$(this).attr('data-ptag')).show();
             ...
             $("#next3").on("click",function(){
                 var email_alert = $("#person_email").val();
	 ...
	 $("#reg_step4").addClass("reg0003");
      ...
      //$("#sendOTP").on("click",function(){
          ...
          $("#hidden_email").val($("#person_email").val());
          $("#otp_email").val($("#person_email").val());
