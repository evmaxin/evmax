      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7 col-sm-6 col-xs-12" style="margin-right: 6%;">
            <div class="product-details-image">
              <div class="slider-for slider">
                        ...
                        echo $images; } else {  echo 'no_image.png'; } ?>"  alt="<?php if (!empty($row->name)) {
                        echo $row->name;  } ?>">
                       </div>
                       <?php
                      }
                     ...
                     <?php  if(!empty($imageArray)) { $mp=0;$j=1; foreach ($imageArray as $images) { ?>
			...
			<?php
             ...
             <?php $j++;$mp++;} } ?>
              ...
              <ul id="productthumbnail" class="slider slider-nav">
                        <?php  if(!empty($imageArray)) { $mp=0;$k=1; foreach ($imageArray as $images) { 
          ...
          <div class="col-md-4 col-sm-6 col-xs-12" style="box-shadow: 0px 0px 0px 0px #ccc;padding-top: 0px;padding-right: 0px;">
            <div class="info-panel det112">
              <h1 class="product-title Prodev00123"><?php  echo $row->name?$row->name:'';  ?></h1>
              <!-- Rattion Price -->
              <div >
                <ul class="featurs Prodev003">
                   <li> <span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212">Model & Variant :</span> <span class="col-md-6 col-lg-6 col-xs-6"><?php  echo $row->model?$row->model:'';  ?> & <?php  echo $row->varient?$row->varient:'';  
                   $off = $row->offer_price?$row->offer_price:0;
                   ?></span></li>
                 
                   <li><span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212">MRP:</span> <span class="col-md-6 col-lg-6 col-xs-6">&#8377;  <?php $mrp = $row->actual_price?$row->actual_price:0; echo IND_money_format(floatval($mrp));?></span></li>
                  <li><span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212">Discount:</span> <span class="col-md-6 col-lg-6 col-xs-6"> (-) &#8377;<?php $disc = $mrp - $off; echo IND_money_format(floatval($disc));?></span></li>
                  
                   <li><span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212" style="color: green !important;font-size: 18px;">Selling Price:</span>   <span class="col-md-6 col-lg-6 col-xs-6" style="color: green !important;font-size: 18px;">&#8377;<?php echo IND_money_format(floatval($off));?></span></li>
                  
                   <li><span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212">Coupon Discount:</span>   <span class="col-md-6 col-lg-6 col-xs-6">&#8377;<?php echo IND_money_format(floatval(300));?></span></li>
                   <li><span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212" style="color: green !important;font-size: 18px;">Offer Price:</span>   <span class="col-md-6 col-lg-6 col-xs-6" style="color: green !important;font-size: 18px;">&#8377;<?php echo IND_money_format(floatval(($off-300)));?></span></li>
                  
                   <li><span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212">Registration :</span> <span class="col-md-6 col-lg-6 col-xs-6"><?php  echo ($row->need_registration==='1')?"Yes":'No';  ?></span></li>
                  <li><span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212">Licence :</span> <span class="col-md-6 col-lg-6 col-xs-6"><?php  echo ($row->need_driving_license==='1')?"Yes":'No';  ?></span></li>
                  <li class="Prodev00212"><b>EMI </b>:</li>
                  
                  
                  <li><span class="col-md-6 col-lg-6 col-xs-6 lbl Prodev00212">Special Offer :</span> <span class="col-md-6 col-lg-6 col-xs-6"><?php  echo ($row->special_offer==='1')?"Yes":'No';  ?></span></li>
                  <li class="Prodev00212"><b>Promo Code </b>:</li>
                  <li class="Prodev00212"><b>State </b>:</li>
                  <li class="Prodev00212"><b>Insurance </b>:</li>
                   <li class="Prodev00212"><b>Add Ons </b>:</li>
              ...
              <div class="color-list1 ">
                        ...
                        <div class="inner_validations" style="color: red;"></div>
              <?php  foreach ($productattributes as $attributes) { 
                            if($attributes->visible_on_detail_page==1) {                                         
               echo "<div class='single_atr'> <span class='col-md-6 col-lg-6 col-xs-6 lbl Prodev00212'>". $attributes->attribute_type .":"."</span>";
              ...
              ?><span class="col-md-6 col-lg-6 col-xs-12 col-sm-12" style="padding: 0px 8px;">
               <select style="<?php if($attributes->visible_on_detail_page==0) { echo 'visibility: hidden;float: right;';}?>" name="<?php echo $attributes->attribute_type; ?>" id="<?php echo strtolower($attributes->attribute_type); ?>" class="target selectsty <?php echo $attributes->attribute_type;?>" atr="<?php echo $attributes->attribute_type."~".$attributes->attribute_type_id;?>">
...
<!--<div class="delivery_location1">
    ...
    <span class="col-md-6 col-lg-6 col-xs-12 col-sm-12 lbl Prodev00212">Pincode: </span> <span class="col-md-6 col-lg-6 col-xs-12 col-sm-12"  style="padding: 0px 8px;"><input type="text" name="pincode" id="pincode" pattern="[0-9]+" class="Prodev00212 Prodev002122A" maxlength="6" minlength="6" onkeypress="return isNumber(event)" style="padding: 0px;font-size: 11px;" placeholder="Enter Delivery Pincode" ></span>
              ...
              <div class="quantity-cart">
                  <button style="border: none;" type="button" class="btn btn-common add_to_cart Prodev004 Prodev002031" product_id="<?php echo $row->product_id;?>"><i class="icon-basket-loaded-loaded"></i> add to cart</button>
