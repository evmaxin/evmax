...
<div class="w3-content w3-display-container" id="faq">
    <img class="mySlides" src="<?php echo base_url() ?>assets/frontend/img/enquiry/reg_banner.jpg" style="width:100%">
</div>
...
<div id="content">
    <div class="container">
        <div class="head-faq text-center">`
            <h3><a href="<?php echo base_url(); ?>Registration/faq">
...
<div id="content1">
                    ...
                    <div class="col-md-12 reg2 reg22" style="float: none;">
                        ...
                        <div class="form-group md-form">
                         ...
                         <div class="form-group md-form mt-3">
                            <label class="control-label labelEnquiry">Contact Person Name *</label>
                        ...
                        <div class="form-group md-form mt-3">
                            ...
                            <input  type="text" placeholder="Contact Number" id="businessPhone" name="businessPhone" class="form-control" title="Please check  contact number " pattern="[0-9]{10}"   maxlength="10" required onkeyup="this.value = this.value.replace(/[^0-9]/g, '');">
    ...
    <input name="chk2"  class="check_box" type="checkbox" data-ptag="sb2" id="chk2" value="">checkme2-->
                        ...
                        <div class="form-group md-form mt-3">
                            ...
                            <small id="gst_info"></small>

                        </div>


                        <div class="form-group md-form mt-3">
                            <label class=" control-label labelEnquiry" >Bank Name *</label>
                            <input  type="text" placeholder="Bank Name" id="bankname" name="bankname" class="form-control" title="Please check  Bank Name"   maxlength="100" required>


                        </div>

                        <div class="form-group md-form mt-3">
                            <label class=" control-label labelEnquiry" >Bank Branch *</label>
                            <input  type="text" placeholder="Bank Branch" id="bankbranch" name="bankbranch" class="form-control" title="Please check  Bank Branch"  maxlength="100" required>


                        </div>
                        <div class="form-group md-form mt-3">
                            <label class=" control-label labelEnquiry" >IFSC Code *</label>
                            <input  type="text" placeholder="IFSC Code" id="ifsc" name="ifsc" class="form-control" title="Please check  Bank IFSC"   maxlength="50" required>


                        </div>
                        <div class="form-group md-form mt-3">
                            <label class=" control-label labelEnquiry" >Bank Account Number *</label>
                        ...
                        <div class="form-group md-form mt-3">
                            <label class=" control-label labelEnquiry" >Bank Account Name *</label>
                            <input  type="text" placeholder="Bank Account Name" id="accountName" name="accountName" class="form-control" title="Please check  Account Name"   maxlength="100" required>
                ...
                <div class="row setup-content-2" id="step-3">
                    <div class="col-md-12 reg211 reg22" style="float: none;">
                        ...
                        <div style="height: 300px; overflow: auto;border: 1px solid #ddd;padding: 9px 9px;">
                            <p>
                        ...
                        <div class="form-check">
                            <input type="checkbox" id="checkbox111" class="checkbox111 form-check-input" required>
                            <label for="checkbox111" class="form-check-label">I agree to the terms and conditions</label>
                        </div>
                        <div style="height: 300px; overflow: auto;border: 1px solid #ddd;padding: 9px 9px;"><br>
                        ...
                        <div class="form-check">
                            <input type="checkbox" id="checkbox1111" class="checkbox111 form-check-input" required>
                            <label for="checkbox1111" class="form-check-label">I agree to the terms and conditions</label>
                        </div>
...
?>
                        ...
                        <!--<button class="btn btn-success resend_diabled" id="resend"> Resend OTP</button>--><br>
                    </div>
                </div>
            </form>
            <!-- Fourth Step -->

            <div class="row setup-content-2" id="step-4" style="padding: 30px 10px;box-shadow: 0 5px 10px 0 rgba(0, 0, 0, 0.2);">
                <button class="button button-rounded button-small button-dark nomargin resend_hidden" type="button" style="font-size: 12px;position: relative;left: 37%;" id="resend">Resend OTP</button>      
                ...
                <div class="" style="border: 1px solid #ccc;">
                    ...
                    <div class="row nomargin clearfix">
                        <div class="col-md-6 hidden-xs" data-height-xl="330" data-height-lg="330" data-height-md="330" data-height-sm="0" data-height-xs="0" style="background-image: url(../assets/frontend/img/4.jpg); background-size: cover; height: 330px;" ></div>
                        <div class="col-md-6 col-padding12" data-height-xl="456" data-height-lg="456" data-height-md="456" data-height-sm="456" data-height-xs="456">
                            <div>
                                <h4 class="uppercase ls1 "><i class="icon-ok-sign reg4step iconcolr"></i></h4>

                                <div class="col_full">
                                    <p class="parabottm"> Verify (OTP Sent to Mobile and Email) <!--<span id="otp_email"></span>--></p>
                                </div>
                                <div class="col_full">
                                    <label class="bottm">Enter OTP: </label>
                                    <span style="padding-left: 18px;"> <input  type="text" placeholder="OTP" id="Otp" name="Otp" class="sm-form-control11" pattern="[0-9]{6}" title="" maxlength="6" required onkeyup="this.value = this.value.replace(/[^0-9]/g, '');"></span>
                                    <input type="hidden" name="hidden_email" id="hidden_email1">

                                </div>

                                <div class="col_full nobottommargin">

                                    <button class="button button-rounded button-small button-dark nomargin" id="resend1"> Resend OTP</button>
                                    <button id="submitfinal" class="button button-rounded button-small button-dark nomargin" type="submit" value="submit">Submit</button><br>
        ...
        <div class="questions-box text-center" id="support">
            <h1>Still Have Questions? Contact Us</h1>
            <div class="row">
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                    <span><b>Call Us:</b></span>
                    <div class="">+91-9205-991-992</div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6">
                    <span><b>Send an Email:</b></span>
                    <div class="">info@evmax.in</div>
                </div>
            </div>
        </div>
