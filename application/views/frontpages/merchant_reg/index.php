 ...
 <div class="form-group md-form mt-3">
    ...
    <?php }
                        ...
                        <div class="form-group md-form mt-3">
                            ...
                            <input  type="text" placeholder="Aadhaar" id="adhaar" name="adhaar" class="form-control" pattern="[0-9]{12}" title="Please check  Aadhaar Number" required maxlength="12" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
