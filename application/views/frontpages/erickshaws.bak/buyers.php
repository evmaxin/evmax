...
if(isset($sliderImages)) { 
  ...
  foreach ($erickshaws as $ads) { ?>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 topmargin bottommargin-sm134 firstbox"><div class="" style="float: right;"><?php if(isset($ads->url) && !empty($ads->url)){ ?><a target="_blank" href="<?php echo $ads->url;?>"><?php } ?><img src="<?php echo base_url() ?>public/uploads/admin/erickshawfactory/<?php echo $ads->brand_banner;?>" class="img-responsive"><?php if($ads->url !==""){ ?></a><?php } ?></div></div>
