<?php
class BatteryBanks_model extends CI_Model {
   //get product details, //$from_home_page to display all products in child catergories from home page
        ...
        {                          
                               if ($this->uri->segment(1) === "store") {
                                ...
                                $this->db->select("prod.store_id,st.store_name,st.store_slug,prod.lng,prod.lat,prod.cat_id,prod.id,prod.name,prod.selling_price,prod.notes,prod.price,prod.valid_from,prod.valid_to,prod.address");
				              $this->db->from('batterybanks prod');
                               ...
                               // $this->db->join('product_images pimg','prod.product_id=pimg.product_id','LEFT');
                                ...
                                $this->db->join('category cat','cat.category_id=prod.cat_id','LEFT');
