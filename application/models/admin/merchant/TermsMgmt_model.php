<?php
class TermsMgmt_model extends CI_Model {
        ...
        {
                                $this->db->select('name,slider_category_id,slider_text,slider_id,display_order,link_to_category');
				$this->db->from('slider');
        ...
        public function destroy($id) {
            if(isset($id)&&($id>0))
            {
            $this->db->delete('m_terms_docs', array('m_terms_docs_id' => $id));
            return true;
            }
